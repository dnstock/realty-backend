...
def get_all(db: Session, parent_id: int, skip: int = 0, limit: int = 10) -> List[Lease]:
    return base.get_all(db=db, model=Lease, parent_key="unit_id", parent_value=parent_id, skip=skip, limit=limit)
