...
def get_all(parent_id: int, skip: int = 0, limit: int = 10) -> List[Property]:
    return base.get_all(model=Property, parent_key="manager_id", parent_value=parent_id, skip=skip, limit=limit)
