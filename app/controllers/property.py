...
def get_all(db: Session, parent_id: int, skip: int = 0, limit: int = 10) -> List[Property]:
    return base.get_all(db=db, model=Property, parent_key="manager_id", parent_value=parent_id, skip=skip, limit=limit)
